                    ...
                    <form id="wizardForm">
                        ...
                        <div class="step-content mt-3">
                            ...
                            <div class="mode-script" id="RTE" style="display: none;">
                                <i class="mode-para2"><span class="mode-para1"
                                        style="color: purple;font-weight: bold;">RTE
                            ...
                            <div class="mode-script" id="Call" style="display: none;">
                                ...
                                <i class="mode-para2" style="color: darkblue;font-weight: 400;">"Hello, my name is [Your
                                    ...
                                    eligibility and benefits for our patients. Could you assist me with this,
                                    please?"</i>
                        ...
                        <div class="step-content">
                            ...
                            <i class="status-msg">Script: "Could you confirm the member’s eligibility before moving on
                                to
                                the benefits?"</i>
                        ...
                        <div class="step-content">
                            <div class="participation-box">
                                ...
                                <label>Participation Status <span class="text-danger">*</span><br>
                                    <i class="participation-status">Script: "May I know whether our provider is In
                                        network
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-6 col-12" id="Out of Network" style="display: none;">
                                    ...
                                    <select name="OON-Coverage-select" class="form-select mt-2 mb-0"
                                        id="coverage-selection" onchange="coverageFunction()">
                                        <option value="" disabled selected>Select coverage</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                                    <p style="font-size:12px;color:red;display:none;" id="No">Action: Proceed to
                                        Closing.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 form-group-tight">
                                    ...
                                    <i class="helper" style="color:#9e9d9d;">
                                        IF &gt; 50%, ask "May I know whether it is patient responsibility or insurance
                                        cover
                                        amount?"
                                    </i>
                                </div>
                            ...
                            <div class="row gx-4 gy-1">
                                <div class="main-coordination">
                                    ...
                                    <div class="col-12 form-group-tight">
                                        ...
                                        <label class="subtitle">COB Status <span class="text-danger">*</span></label>
                                        <br>
                                    ...
                                    <div id="secondaryDetails" class="col-12 row gx-4 gy-1" style="display:none;">
                                        ...
                                        <div class="col-12 form-group-tight">
                                            ...
                                            <i id="tertiaryScript" class="helper" style="display:none;">
                                                Script: "Since this plan is Tertiary, who is updated as Primary? Could
                                                you
                                                please provide the other insurance information if available?"
                                            </i>
                                        </div>
                                ...
                                <div class="col-12 row gx-4 gy-1 align-items-end">
                                    ...
                                    <div class="col-md-6 form-group-tight">
                                        <p style="color: #6c757d;font-size: 14px;font-weight: 450;" class="mb-0">PRIOR
                                            AUTH
                                        </p>
                                ...
                                <div id="faxDetailsSection" class="col-12 row gx-4 gy-1" style="display:none;">
                                    ...
                                    <div class="col-md-6 form-group-tight">
                                        <label>Fax Attention <br>
                                            <i class="helper">
                                                Script: "May I know to whose attention I need to send the
                                                documentation?"
                                            </i>
                                        </label>
                                        <input type="text" class="form-control">
                        ...
                        <div class="step-content">
                            ...
                            <div class="final-details">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6 col-12">
                                        ...
                                        <p style="color: #6c757d;font-size: 12px;">Select the outcome of your
                                            verification
                                            (Call/Web/RTE).</p>
                                    </div>
                                    <div class="col-md-6 col-12">
                            ...
                            <div class="mt-3 d-flex justify-content-center mb-4">
                                <i style="color: #6c757d;font-size: 14px;">Closing Script: "Thank you for your
                                    assistance
